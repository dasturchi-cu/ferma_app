...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget _buildSecuritySettings() {
    return Card(
      ...
      child: Column(
        children: [
          ListTile(
            leading: const Icon(Icons.fingerprint, color: AppTheme.primaryGreen),
    ...
    return Card(
      ...
      child: Column(
        children: [
          ...
          const Divider(height: 1),
          ListTile(
            leading: const Icon(Icons.cloud_download, color: AppTheme.primaryGreen),
    ...
    return Card(
      ...
      child: Column(
        children: [
          ...
          const Divider(height: 1),
          ListTile(
            leading: const Icon(Icons.help, color: AppTheme.primaryGreen),
          ...
          const Divider(height: 1),
          ListTile(
            leading: const Icon(Icons.feedback, color: AppTheme.primaryGreen),
        ...
        content: Column(
          ...
          children: [
            ListTile(
              ...
              trailing: _currency == 'UZS' ? const Icon(Icons.check, color: AppTheme.primaryGreen) : null,
              onTap: () {
                setState(() {
                  _currency = 'UZS';
                });
            ...
            ListTile(
              ...
              trailing: _currency == 'USD' ? const Icon(Icons.check, color: AppTheme.primaryGreen) : null,
              onTap: () {
                setState(() {
                  _currency = 'USD';
                });
  ...
  void _showAboutDialog() {
    showAboutDialog(
      ...
      applicationIcon: const Icon(Icons.agriculture, size: 48, color: AppTheme.primaryGreen),
      children: [
        const Text(
