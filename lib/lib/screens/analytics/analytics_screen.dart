...
class _AnalyticsScreenState extends State<AnalyticsScreen>
  ...
  void _updateChartData() {
    ...
    _revenueData.add(BarChartGroupData(
      x: 6,
      barRods: [
        BarChartRodData(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Icon(Icons.bar_chart, color: AppTheme.primaryGreen, size: 24),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.emoji_events, color: AppTheme.primaryGreen, size: 24),
              const SizedBox(width: 8),
              const Text(
